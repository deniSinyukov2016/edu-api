...
"use strict"
    //parallax
    $('.parallax-window').parallax({imageSrc: 'images/12345.jpg'});
    ...
    // $(document).ready(function(){
    //     $("#listCategory").on("click", "a", function (event) {
    ...
    jQuery("a[rel^='prettyPhoto']").prettyPhoto();
        ...
        if (screen.width <= 1199 && screen.width >= 991) {
            $('.courses-tile').removeClass('col-md-3').addClass('col-md-4');
            $('.courses-tile:last-of-type').css('display', 'none');
        }
        ...
        if (window.location.origin === 'https://prod.edu.cronix.ms') {
            $('#sign-in, #sign-in-mob').attr('href', 'https://prod.edu-user.cronix.ms');
        }
        else if (window.location.origin === 'https://edu-api.cronix.ms') {
            $('#sign-in, #sign-in-mob').attr('href', 'https://dev.edu-user.cronix.ms/login') ;
        }
        else {
            $('#sign-in, #sign-in-mob').attr('href', 'https://dev.edu-user.cronix.ms/login') ;
        }
